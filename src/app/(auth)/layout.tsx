 ...
 * Auth Layout
 *
 * Modal-style layout for authentication pages.
 * Shows a centered card with blurred/darkened backdrop.
 */
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="relative min-h-screen flex items-center justify-center p-4">
        {/* Modal card */}
        <div className="relative w-full max-w-md bg-white rounded-2xl shadow-xl p-8 animate-in fade-in zoom-in-95 duration-200">
          {/* Close button */}
          <Link
            href="/"
