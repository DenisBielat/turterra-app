...
export default function SpeciesComparison({
  ...
  return (
    <div className="space-y-6">
      {/* Top Section - Species Cards - Horizontally scrollable on mobile */}
      <div className="overflow-x-auto -mx-4 px-4 lg:mx-0 lg:px-0 lg:overflow-visible">
        <div className="flex lg:grid lg:grid-cols-[1fr_auto_1fr] gap-4 min-w-max lg:min-w-0">
          {/* Primary Species Card */}
          <div className="w-[85vw] flex-shrink-0 lg:w-auto">
            <SpeciesCard {...primarySpecies.speciesCard} />
          </div>

          {/* Spacer column */}
          <div className="w-4 lg:w-6 flex-shrink-0" />

          {/* Comparison Species Card or Compare UI */}
          <div className="w-[85vw] flex-shrink-0 lg:w-auto">
            {isLoading ? (
              <div className="w-full h-full flex flex-col items-center justify-center border border-gray-300 rounded-lg bg-gray-50 animate-pulse min-h-[200px]">
              ...
              <div className="w-full h-full flex flex-col items-center justify-center border border-red-300 rounded-lg bg-red-50 p-4 min-h-[200px]">
              ...
              <button
                ...
                className="w-full h-full flex flex-col items-center justify-center border border-dashed border-gray-300 rounded-lg hover:bg-green-900/20 transition-all min-h-[200px]"
              >
      ...
      {/* Bottom Section - Physical Features - Horizontally scrollable on mobile */}
      <div className="overflow-x-auto -mx-4 px-4 lg:mx-0 lg:px-0 lg:overflow-visible">
        <div className="flex lg:grid lg:grid-cols-[1fr_auto_1fr] gap-4 min-w-max lg:min-w-0">
                  ...
                  {relatedSpecies.map((species) => (
                    ...
                    >
                      <div className="flex items-center">
                        <div className="relative w-24 lg:w-32 h-16 lg:h-20 overflow-clip flex-shrink-0">
                          <Image
                        ...
                        <div className="flex flex-col items-start gap-1 px-3 lg:px-4">
                          <div className="font-heading font-bold text-white text-sm lg:text-base">
                            {species.commonName}
                          </div>
                          <div className="text-xs lg:text-sm italic text-white">
                            {species.scientificName}
                          </div>
                        </div>
                      </div>
                      <div className="px-3 lg:px-4">
                        <div className="w-8 h-8 lg:w-10 lg:h-10 flex items-center justify-center rounded-full bg-white hover:bg-green-500 hover:outline-1 hover:outline-dashed hover:outline-green-500 hover:outline-offset-2 transition-all duration-200">
                          <Icon
                            name="add"
                            size="sm"
                            style="line"
