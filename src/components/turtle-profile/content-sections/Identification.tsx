      ...
      <div className="mt-12">
        ...
        <div className="mt-12 max-w-lg">
          ...
          <p className="mt-2 text-base">
            This section highlights each physical feature of the turtle as observed in the &ldquo;reference&rdquo; variant (Adult Male). If you see a variant icon next to a feature, it means there are known differences in that feature for other sexes or life stages (e.g., juvenile, hatchling). Clicking the icon will display a quick comparison, so you can see exactly how that feature varies across the same turtle species. 
          </p>
        </div>
